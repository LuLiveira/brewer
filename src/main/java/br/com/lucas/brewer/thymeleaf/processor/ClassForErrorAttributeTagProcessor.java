...
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	private static final String CLASS_FOR_ERROR = "classforerror";
	private static final Integer PRECEDENCIA = 1000;
	
	public ClassForErrorAttributeTagProcessor(String dialectPrefix) {
		super(TemplateMode.HTML, dialectPrefix, null, false, CLASS_FOR_ERROR, true, PRECEDENCIA,
				true);
	}
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
		...
		if(hasError) {
			String classesExistentesNoHtml = tag.getAttributeValue("class");
			structureHandler.setAttribute("class", classesExistentesNoHtml.concat(" has-error"));
		}
